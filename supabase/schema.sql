...
-- 6) Audio dei pianti: bucket privato "cries", una cartella per famiglia (<family_id>/<event_id>.<ext>).
...
-- 7) Nome visualizzato di ciascun genitore (l'app lo legge dal profilo dell'utente loggato):
