...
- **Ascolto del pianto** (Altro → Ascolto, acceso solo sul dispositivo che vuoi): lasci l'app aperta su un iPad nella stanza e lui sente i pianti e li segna da solo, con ora, durata e tono. Serve a sapere quante volte piange senza dover pensare a far partire una registrazione. Dalla riga in Oggi accendi lo schermo scuro (solo ora e stato, si tocca dove vuoi per tornare all'app). Mentre piange la schermata dice l'ipotesi più probabile e cosa provare; l'audio si tiene solo per i pianti nitidi, da riascoltare. Funziona solo con l'app in primo piano e lo schermo acceso (il permesso al microfono si dà una volta per apertura).
- **Cosa provare**: quando c'è un pianto senza spiegazione, in Home compare l'ipotesi con la percentuale e i pulsanti delle due cause più probabili. Tocchi Pappa o Nanna e, registrando quello che fai, il pianto resta spiegato.
- **Quali chiedere**: in Pianti decidi quanto lunghi devono essere i pianti sentiti dall'app perché l'app te li chieda (sempre, 30 s, 1, 2 o 5 minuti; di suo un minuto). Quelli che registri tu con "Piange" si chiedono sempre. Gli altri restano nel diario e nei numeri: li spieghi quando vuoi, o mai.
- **Spiegare con calma**: niente ti obbliga a catalogare subito. "Dopo" toglie il banner di mezzo per due ore e il pianto resta lì; se intanto registri una pappa, si spiega da solo. Quando vuoi, apri il pianto e in "Cosa avete fatto dopo" tocchi l'azione che lo ha calmato: la spiegazione la prende da lì, anche a ore di distanza.
