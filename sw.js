...
var CACHE='alan-shell-v2';
var SHELL=['./','./index.html','./css/app.css?v=2','./js/config.js?v=2','./js/sync.js?v=2','./js/app.js?v=2','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./icons/apple-touch-icon.png'];
